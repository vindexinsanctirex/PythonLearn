...
# # Exemplo 15: Testando todas as operações relacionais
# a = 5
# b = 10
# if a < b:
...
usuario_logado = input("O usuário está logado? (s/n): ").lower() == 's'
usuario_admin = input("O usuário é admin? (s/n): ").lower() == 's'
if usuario_logado:
    if usuario_admin:
